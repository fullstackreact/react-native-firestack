...
export class Authentication extends Base {
  constructor(firestack, options={}) {
    ...
    this._addToFirestackInstance(
      ...
      'deleteUser', 'getToken',
      'signOut', 'getCurrentUser', 'signInAnonymously',
    )
  }

  /**
   * Sign an anonym user without parameters
   * @return {Promise}         A promise with anonym logged user or an error if fail
   */
  signInAnonymously() {
    this.log.info('Signing in anonymously');
